const e=`{
  ...
  "modules": [
    {
      ...
      "chapitres": [
        {
          "id_chapitre": 1,
          "titre": "Le conseil et conseiller",
          "contenu_detaille": "Le dictionnaire donne 'Ladjili' (ou 'ladili') pour le nom 'conseil', et 'Ladji' (ou 'ladi') pour le verbe 'conseiller'.",
          "vocabulaire_cles": [
            {
              "terme": "Ladjili / ladili",
  ...
  "conclusion": "Cette leçon a présenté les mots pour le conseil (Ladjili) et le verbe conseiller (Ladji), issus des entrées du dictionnaire."
}`;export{e as default};
